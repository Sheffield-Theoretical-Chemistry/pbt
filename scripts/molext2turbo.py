#!/usr/bin/env python3
# Python Basis Tool (pbt) script for reading in Molpro external format and writing TURBOMOLE
#
...
if (len(sys.argv) < 2):
    print("Usage: molext2turbo.py infile [outfile]")
...
#
import turbo
turbo.WriteTurbo(set,precis,outfile)
outfile.close()
