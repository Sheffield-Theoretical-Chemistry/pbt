#!/usr/bin/env python3
# Python Basis Tool (pbt) script for reading in Molpro external format and writing Gaussian
#
...
if (len(sys.argv) < 2):
    print("Usage: molext2gaussian.py infile [outfile]")
...
#
import gaussian
gaussian.WriteGauss(set,precis,outfile)
outfile.close()
