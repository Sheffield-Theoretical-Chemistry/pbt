#!/usr/bin/env python3
# Python Basis Tool (pbt) script for reading in Molpro external format and writing NWChem
#
...
if (len(sys.argv) < 2):
    print("Usage: molint2nwchem.py infile [outfile]")
...
#
import nwchem
nwchem.WriteNWChem(set,precis,outfile)
outfile.close()
