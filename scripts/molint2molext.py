#!/usr/bin/env python3
# Python Basis Tool (pbt) script for reading in Molpro internal (libmol) format and writing to Molpro external format
#
...
if (len(sys.argv) < 2):
    print("Usage: molint2molext.py infile [outfile]")
